		...
		<form action="" method="POST">
			<div class="flex flex-col">
				<div class="flex flex-col gap-2 mb-[1rem]">
                    ...
                    <P class="text-sky-600 font-semibold"><?=$_SESSION['nama_admin'] ?></P>
				</div>
				...
				<div class="flex items-center gap-2 mt-3">
                    <a href="?hal=profile&aksi=edit&nama_admin=<?= $row['nama_admin']; ?>" class="btn bg-sky-50 border border-sky-600 text-sky-600" >Edit</a>
				</div>
			</div>
		</form>
	</div>
