		...
		<form action="" method="POST">
			<div class="flex flex-col">
				...
				<div class="flex items-center gap-2 mt-3">
					<input type="submit" name="create" value="Edit" class="btn bg-[#DED7FF] border border-[#6C6CE8] text-[#6C6CE8]">
...
if(isset($_POST['create'])){
    ...
    $res = $config->query("UPDATE tb_jurusan SET kd_jurusan= '$kd_jurusan', nama_jurusan = '$nama_jurusan' WHERE kd_jurusan = '$id'");
	if($res){
