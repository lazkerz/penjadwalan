<section>
		<h3 class="text-xl text-center font-semibold text-[#64CAA5]">Tambah Data Pengajar</h3>
		...
		<form action="" method="POST">
			<div class="flex flex-col">
				...
				<div class="flex items-center gap-2 mt-3">
					...
					<a href="index.php?hal=data-pengajar" class="btn btn-ghost border-0">Kembali</a>
				</div>
			</div>
		</form>
	</div>
